...
public class PlayeraFXMLController implements Initializable {
    ...
    private void handleBtnSi(ActionEvent event)throws IOException {
        ...
        resultado = se.ObtenerPlayera("NoPhineas", "si");
    ...
    public void handleBtnNo(ActionEvent event) throws IOException {
        String resultado;
        SistemaExperto se = new SistemaExperto();
        resultado = se.ObtenerPlayera("NoPhineas", "no");
        lblres1.setText(resultado);
        ((Node)event.getSource()).getScene().getWindow().hide();
        Parent parent = FXMLLoader.load(getClass().getResource("PeloFXML.fxml"));
